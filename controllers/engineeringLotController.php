<?php
class EngineeringLotController extends WipAppModel{
	...
	public function getEngineeringLotCount(){
		$sql 	= "	SELECT 
						PKG
					FROM
						MO_INVALID
	...
	public function getEngineeringLotInvValue(){
		$sql 	= "	SELECT 
	...
	public function getEngineeringLotPackages(){
		$sql 	= "	SELECT 
						PKG,
	...
	public function getEngineeringLotDevice(){
		$sql 	= "	SELECT 
						DEVICE,
						SUM(CTR_MO) AS CTR_MO,
						SUM(SCHEDULED_QUANTITY) AS SCHEDULED_QUANTITY,
	...
	public function getEngineeringLotMo(){
		$sql 	= "	SELECT 
						MO,
						CUSTOMER,
						SCHEDULED_QUANTITY,
