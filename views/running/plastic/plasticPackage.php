	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<script>$(document).ready(function() { $('#yield-sot-detls').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 4, "desc" ]]}); } );</script>
				...
				<div id="yield-running-sot">
					<table id="yield-sot-detls" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							...
							$cntr = 1;
							if($data = $package->getPlasticPackage()){
								foreach($data as $row){
									...
									<tr>
										<td>
											<a href="?page=running-yield-plastic-dvc&
