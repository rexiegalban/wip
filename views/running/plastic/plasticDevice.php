<div class="row">
		<ol class="breadcrumb">
			<li>
				<a href="?page=running-yield-plastic-pkg">
	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<ul class="nav nav-pills">
				...
				<li class="active"><a href="?page=running-yield-plastic-pkg">PLASTIC</a></li>
			...
			<div class="panel-body">
				...
				<div id="yield-running-plastic" style="display:;">
					...
					<script>$(document).ready(function() { $('#yield-plastic-dtls').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 4, "desc" ]]}); } );</script>
					<table id="yield-plastic-dtls" class="table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<tbody>
							<?php 
								...
								$cntr = 1;
								if($data = $device->getPlasticDevice()){
									foreach($data as $row){
										...
										<tr>
											<td style="text-align:left;">
												<a href="?page=running-yield-plastic-mo&
