			...
			<div class="panel-heading">
				...
				<small>- PACKAGE</small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#end-of-line-packages').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 5, "desc" ]]}); } );</script>

						<table id="end-of-line-packages" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								$packages = new EndOfLineController($_REQUEST);
								if($data = $packages->getEndOfLinePackages()){
									foreach($data as $row){
										...
										<tr>
											<td>
												<a href="?page=end-of-line-device&
