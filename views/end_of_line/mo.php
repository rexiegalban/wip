			...
			<span style="margin-left:15px;">
				...
				<small> DEVICE:<span style="color:#428BCA;"> <b><?php echo @$_REQUEST['dvc']; ?></b> </span></small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#end-of-line-mo').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 9, "desc" ]]}); } );</script>

						<table id="end-of-line-mo" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								$mo = new EndOfLineController($_REQUEST);
								if($data = $mo->getEndOfLineMo()){
									foreach($data as $row){
