			...
			<span style="margin-left:15px;">
				...
				<small> DEVICE:<span style="color:#428BCA;"> <b><?php echo @$_REQUEST['dvc']; ?></b> </span></small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#on-hold-mo').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 10, "desc" ]]}); } );</script>

						<table id="on-hold-mo" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								$mo = new OnHoldController($_REQUEST);
								if($data = $mo->getOnHoldMo()){
									foreach($data as $row){
