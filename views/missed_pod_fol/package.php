			...
			<div class="panel-heading">
				...
				<small>- PACKAGE</small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#missed-pod-fol-packages').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 6, "desc" ]]}); } );</script>

						<table id="missed-pod-fol-packages" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
								...
								if($data = $packages->getActiveMoPackages()){
									foreach($data as $row){
										...
										*/?>
										<tr>
											<td>
												<a href="?page=missed-pod-fol-device">
