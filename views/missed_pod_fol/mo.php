			...
			<span style="margin-left:15px;">
				...
				<small> DEVICE:<span style="color:#428BCA;"> <b><?php echo '0'; ?></b> </span></small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#missed-pod-fol-mo').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]]}); } );</script>

						<table id="missed-pod-fol-mo" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
