			...
			<div class="panel-heading">
				...
				<small>- PACKAGE</small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#shipping-packages').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 5, "desc" ]]}); } );</script>

						<table id="shipping-packages" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								$packages = new ShippingController($_REQUEST);
								if($data = $packages->getShippingPackages()){
									foreach($data as $row){
