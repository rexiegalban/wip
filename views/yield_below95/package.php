			...
			<div class="panel-heading">
				...
				<small>- PACKAGE</small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#yield-below-95-packages').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 7, "desc" ]]}); } );</script>

						<table id="yield-below-95-packages" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								$packages = new YieldBelow95Controller($_REQUEST);
								if($data = $packages->getYieldBelow95Packages()){
									foreach($data as $row){
									...
									?>
										<tr>
											<td>
												<a href="?page=yield-below-95-device&
