			...
			<span style="margin-left:15px;">
				...
				<small> DEVICE:<span style="color:#428BCA;"> <b><?php echo @$_REQUEST['dvc']; ?></b> </span></small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#on-schedule-mo').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 10, "desc" ]]}); } );</script>

						<table id="on-schedule-mo" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								$mo = new OnScheduleController($_REQUEST);
								if($data = $mo->getOnScheduleMo()){
									foreach($data as $row){
