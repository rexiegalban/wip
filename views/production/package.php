			...
			<div class="panel-heading">
				...
				<small>- PACKAGE</small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#production-packages').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 5, "desc" ]]}); } );</script>

						<table id="production-packages" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								$packages = new ProductionLineController($_REQUEST);
								if($data = $packages->getProductionLinePackages()){
									foreach($data as $row){
