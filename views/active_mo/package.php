	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-heading">
				...
				<small>- PACKAGE</small>
				<?php ?>
				<a target="_blank" href="?page=save-xls-active-mo-package" id="dateRange-btn" class="btn btn-default" style="float:right;">
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#active_mo_packages').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 7, "desc" ]]}); } );</script>

						<table id="active_mo_packages" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
