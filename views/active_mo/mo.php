	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-heading">
				...
				<small>- MO</small>
				<a target="_blank" 
					href="?page=save-xls-active-mo-mo&
							pkg=<?php echo $_REQUEST['pkg']; ?>&
							dvc=<?php echo $_REQUEST['dvc'] ?>" 
			...
			<span style="margin-left:15px;">
				...
				<small> DEVICE:<span style="color:#428BCA;"> <b><?php echo @$_REQUEST['dvc']; ?></b> </span></small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#active_mo_mo').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 11, "desc" ]]}); } );</script>

						<table id="active_mo_mo" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								$mo = new ActiveMOController($_REQUEST);
								if($data = $mo->getActiveMoMo()){
									foreach($data as $row){
