	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			...
			<div class="panel-heading">
				...
				<small>- DEVICE</small>
				<!-- <a target="_blank" 
					href="?page=save-xls-engineering-lot-device&pkg=<?php echo $_REQUEST['pkg']; ?>" 
			...
			<span style="margin-left:15px;">
				...
				<small> PACKAGE:<span style="color:#428BCA;"> <b><?php echo @$_REQUEST['pkg']; ?></b> </span></small>
					...
					<div class="panel-body">
						...
						<script>$(document).ready(function() { $('#engineering-lot-device').DataTable({"lengthMenu": [[15, 50, 100, -1], [15, 50, 100, "All"]],	"order": [[ 7, "desc" ]]}); } );</script>

						<table id="engineering-lot-device" class="table table-striped table-bordered" cellspacing="0" width="100%">
							<thead>
								<tr>
							...
							<tbody>
								...
								$device = new EngineeringLotController($_REQUEST);
								if($data = $device->getEngineeringLotDevice()){
									foreach($data as $row){
										...
										<tr>
											<td>
												<a href="?page=engineering-lot-mo&
